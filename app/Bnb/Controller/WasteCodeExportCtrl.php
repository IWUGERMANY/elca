...
use Bnb\View\WasteCodeExportView;
 ...
 */
class WasteCodeExportCtrl extends AppCtrl
{
    ...
    protected function defaultAction($addNavigationViews = true, $Validator = null)
    {
        ...
        $view = $this->setView(new WasteCodeExportView());
        ...
        if ($addNavigationViews) {
            ...
            $this->Osit->add(new ElcaOsitItem(t('Abfallschlüssel'), null, t('weiterer Bezeichner')));
        }
    }
    // End defaultAction
    ...
    protected function downloadAction()
    {
        ...
        $filename = \trim($project->getName() .'-Abfallschluessel-'. date('YmdHis')).".csv";
