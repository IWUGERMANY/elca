...
class Assembler
{
    const DIN_OUTER_WALLS = '330';
    const DIN_WINDOWS = '334';
    const DIN_OUTER_WALL_CLADDING = '335';
    const DIN_INNER_WALL_CLADDING = '336';
    const DIN_SUNSCREEN = '338';

    const IDENT_WINDOW = 'window';
    ...
    private function updateElementComponents($elementId, $callback)
    {
        ...
        $components = ElcaElementComponentSet::findByElementIdAndAttributeIdent($elementId, WindowAssistant::IDENT);
     ...
     * @return ElcaElementComponent
     */
    private function createComponentAttribute(ElcaElementComponent $component, $ident = WindowAssistant::IDENT)
    {
