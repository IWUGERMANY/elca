...
use Elca\View\Assistant\DormerAssistantView;
 ...
 */
class DormerCtrl extends TabsCtrl
{
    const CONTEXT = 'assistant/dormer';
    ...
    protected function init(array $args = [])
    {
        ...
        $this->assistant = $this->container->get(DormerAssistant::class);
    ...
    {
        $view = $this->setView(new DormerAssistantView());
    ...
    public function saveAction()
    {
        ...
        if ($Validator->isValid()) {
            ...
            $windowAssembler = new DormerAssembler($window, $this->context === ProjectElementsCtrl::CONTEXT? $this->Elca->getProjectVariantId() : null);
    ...
    protected function selectProcessConfigAction()
    {
        ...
        elseif(isset($this->Request->select))
        {
            ...
            $view = $this->setView(new DormerAssistantView());
            $view->assign('context', $this->context);
            $view->assign('buildMode', DormerAssistantView::BUILDMODE_SELECTOR);
