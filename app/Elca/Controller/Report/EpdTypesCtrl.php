...
class EpdTypesCtrl extends BaseReportsCtrl
{
    /**
     * SessionNamespace
     */
     ...
     * systems action
     */
    protected function epdTypesAction()
    {
        $view = $this->setView(new EpdTypesView());
        $view->assign('projectVariantId', $this->Elca->getProjectVariantId());

        $this->Osit->add(new ElcaOsitItem(t('Bilanz nach EPD Typen'), null, t('Auswertung')));
