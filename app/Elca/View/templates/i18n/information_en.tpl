<div id="content" class="websiteinfo">
	...
	<div class="infocolumns flex wrap">
		<div class="infocolumn">
			...
			<br/>
			<h3>EnEV2eLCA Beschreibung</h3>
			<ul class="downloads">
				<li><a href="/docs/downloads/eLCA-ImportAssistent.pdf" target="_blank" title="eLCA Import-Assistent" class="iconsheet no-xhr">Import-Assistent [PDF, DE]</a><br/>
		...
		<div class="infocolumn">
			<h2>BIM</h2>
			<ul class="downloads">
				<li><a href="/docs/bim/BIM.zip" target="_blank" title="Support IFC format" class="iconsheet no-xhr">Support IFC format [ZIP, DE]</a></li>
			</ul>	
		</div>	        
