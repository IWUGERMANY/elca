 ...
 *
 */
class ElcaReportSummaryPerResidentView extends ElcaReportsView
{
    /**
     * Buildmodes
     */
    ...
    protected function renderReports(
        ...
        $this->addClass($Container, 'report-summary report-summary-residents report-summary-'.$this->buildMode);
