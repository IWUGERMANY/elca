 ...
 *
 */
class WindowElementImageView extends ElementImageView
{
    /**
     * canvas size
     */
    ...
    */
    ...
    {
        $assistantElement = ElcaAssistantElement::findByElementId($element->getId(), WindowAssistant::IDENT);
        ...
        $components = ElcaElementComponentSet::findByElementIdAndAttributeIdent($element->getId(), WindowAssistant::IDENT);
