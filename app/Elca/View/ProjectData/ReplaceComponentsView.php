...
class ReplaceComponentsView extends HtmlView
{
    ...
    protected function init(array $args = [])
    {
        ...
        $this->setTplName('project_data/replace_components');
    ...
    protected function beforeRender()
    {
        ...
        $formId = 'replaceComponentsForm';
        $form   = new HtmlForm($formId, '/elca/project-data/replace-components/save/');
    ...
    private function appendMatchingElements(HtmlElement $container, $compositeElementTypeNodeId, $elementTypeNodeId)
    {
        ...
        foreach ($composites as $compositeElement) {
            ...
            foreach ($compositeElement->getCompositeElements() as $elementAssignment) {
                ...
                $elementLi->add(new ElcaHtmlCheckbox('replaceComponents['. $element->getId().']', $elementAssignment->getCompositeElementId()))->addClass('column check');
    ...
    private function appendTemplateElementSelector(HtmlElement $container, $elementTypeNodeId, $elementId = null)
    {
        ...
        $selector->setUrl(FrontController::getInstance()->getUrlTo(ReplaceComponentsCtrl::class, 'selectElement'));
