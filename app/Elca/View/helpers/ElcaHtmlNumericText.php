 ...
 *
 */
class ElcaHtmlNumericText extends HtmlText
{
    /**
     * Creates a text element
     *
     * @see HtmlText::__construct()
     */
    public function __construct($name, $precision = null, $isPercentage = false, $decPoint = '?', Converter $DefaultConverter = null, DbObject $DataObject = null, $inScientific = false)
    {
