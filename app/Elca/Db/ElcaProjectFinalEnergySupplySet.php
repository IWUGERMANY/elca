...
/**
 * Handles a set of ElcaProjectFinalEnergySupply
 *
 * @package    -
 * @class      ElcaProjectFinalEnergySupplySet
 * @author Fabian Möller <fab@beibob.de>
 * @author Tobias Lode <tobias@beibob.de>
 * @copyright  2014 BEIBOB Medienfreunde
 */
class ElcaProjectFinalEnergySupplySet extends DbObjectSet
{
    /**
    ...
    {
        if(!$projectVariantId)
            return new ElcaProjectFinalEnergySupplySet();

        $initValues = array('project_variant_id' => $projectVariantId);
        return self::_find(get_class(), ElcaProjectFinalEnergySupply::getTablename(), $initValues, $orderBy, $limit, $offset, $force);
    }
    ...
    {
        return self::_count(get_class(), ElcaProjectFinalEnergySupply::getTablename(), $initValues, $force);
    }
    // End dbCount
}
// End class ElcaProjectFinalEnergySupplySet