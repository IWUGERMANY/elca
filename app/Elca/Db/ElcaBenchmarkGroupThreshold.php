 ...
 *
 * @package    -
 * @class      ElcaBenchmarkGroupThreshold
 * @author Fabian Möller <fab@beibob.de>
 * @author Tobias Lode <tobias@beibob.de>
 * @copyright  2018 BEIBOB Medienfreunde
 */
class ElcaBenchmarkGroupThreshold extends DbObject
{
    /**
     * Tablename
     */
    const TABLE_NAME = 'elca.benchmark_group_thresholds';
     ...
     * @return ElcaBenchmarkGroupThreshold
     */
    public static function create($groupId, $score, $caption)
    {
        $ElcaBenchmarkGroupThreshold = new ElcaBenchmarkGroupThreshold();
        $ElcaBenchmarkGroupThreshold->setGroupId($groupId);
        $ElcaBenchmarkGroupThreshold->setScore($score);
        $ElcaBenchmarkGroupThreshold->setCaption($caption);
        
        if($ElcaBenchmarkGroupThreshold->getValidator()->isValid())
            $ElcaBenchmarkGroupThreshold->insert();
    ...
    /**
     * Inits a `ElcaBenchmarkGroupThreshold' by its primary key
     *
     * @param  int      $id    - 
    ...
    {
        if(!$id)
            return new ElcaBenchmarkGroupThreshold();
    ...
    {
        return self::create($groupId, $this->getScore(), $this->getCaption());
    }
...
// End class ElcaBenchmarkGroupThreshold