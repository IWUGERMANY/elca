BEGIN;
SELECT public.register_patch('alter-processes-add-epd_type', 'elca');

ALTER TABLE elca.processes ADD "epd_type" varchar(30);
...
DROP VIEW elca.process_assignments_v;
DROP VIEW elca.export_process_assignments_v;
DROP VIEW elca.processes_v;
