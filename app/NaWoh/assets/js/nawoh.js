        ...
        jBlibs.App.init({
            ...
            controllers: {
                ...
                'nawoh': {
                     ...
                     */
                    views: {
                        '#content.nawoh-water': "prepareWater",
                    },

                    prepareWater: function ($context) {
                        var $tubRadio = $('form .form-section.mitBadewanne input', $context),
                            $tubInput = $('form .form-section.tub-input', $context);

                        $tubRadio.on('change', function () {
                            $tubRadio.closest('form').submit();
                        });
                    }
                }
            }
