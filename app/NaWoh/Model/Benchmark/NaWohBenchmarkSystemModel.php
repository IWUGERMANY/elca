...
namespace NaWoh\Model\Benchmark;

use Elca\Model\Benchmark\BenchmarkSystemModel;
use NaWoh\Controller\WaterCtrl;

class NaWohBenchmarkSystemModel implements BenchmarkSystemModel
{
    ...
    {
        return [
            'caption'=> 'NaWoh Trinkwasserermittlung',
            'module' => 'nawoh',
