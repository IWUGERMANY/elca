...
class FinalEnergySupply
{
    ...
    /**
     * FinalEnergySupply constructor.
     *
     * @param MaterialMapping $materialMapping
     * @param                 $total
     * @param                 $enEvRatio
     */
    public function __construct(MaterialMapping $materialMapping, $quantity, $enEvRatio)
    {
